...
if page == "📊 EDA Overview":
    ...
    st.info("This section will illustrate how changes in assumptions impact outcomes.")
    ...
    with st.spinner("Fetching Malaysia blogs..."):
        text_data = fetch_malaysia_blogs(malaysia_urls)
